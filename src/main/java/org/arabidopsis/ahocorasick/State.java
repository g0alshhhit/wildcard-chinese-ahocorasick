...
class State {
    ...
    // strategy.
    private static final int THRESHOLD_TO_USE_SPARSE = 0;
    ...
    /**
     * Returns the size of the tree rooted at this State. Note: do not call this if there are loops in the edgelist graph, such as
