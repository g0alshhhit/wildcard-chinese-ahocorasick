 ...
 * href="http://portal.acm.org/citation.cfm?id=360855&dl=ACM&coll=GUIDE" target="_blank">Aho-Corasick</a> algorithm is optimized
 * to work with chars.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * 
 * <li>Per user request from Carsten Kruege, I've changed the signature of State.getOutputs() and SearchResults.getOutputs() to
 * Sets rather than Lists.</li>
 * 
 * </ul>
 */
public class AhoCorasick {
    ...
    /**
     * Adds a new keyword with the given output. During search, if the keyword is matched, output will be one of the yielded
    ...
    /**
     * DANGER DANGER: dense algorithm code ahead. Very order dependent. Initializes the fail transitions of all states except for
     * the root.
     */
